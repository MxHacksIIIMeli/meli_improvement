...
# Ejecucion: python keyword_extraction.py 
# Date: 03-10-2015
...
ACCESS_TOKEN = "APP_USR-6490405204826174-100404-3cdf65176efc7a83d86d08271279c4b2__F_G__-66153861"

meli = Meli(client_id=CLIENT_ID, client_secret=CLIENT_SECRET, access_token=ACCESS_TOKEN, refresh_token="Refresh_Token")

#Funcion que crea lista de caracteristicas de objeto y de preguntas
responseItems = meli.get(path="/users/66153861/items/search?access_token=APP_USR-6490405204826174-100404-3cdf65176efc7a83d86d08271279c4b2__F_G__-66153861")
...
for id in idItems:
	...
	#print(questions)
	atender_preguntas(questions,caracteristicas)
